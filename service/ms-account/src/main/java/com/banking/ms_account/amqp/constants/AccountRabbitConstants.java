...
public final class AccountRabbitConstants {
    ...
    public static final String CUSTOMER_CREATED_QUEUE = "account.customer.created";
    public static final String CUSTOMER_CREATED_ROUTING_KEY = "customer.created";

    public static final String CUSTOMER_STATUS_UPDATED_QUEUE = "account.customer.status.updated";
